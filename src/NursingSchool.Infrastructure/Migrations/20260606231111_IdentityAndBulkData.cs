...
{
    /// <inheritdoc />
    public partial class IdentityAndBulkData : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClinicalFacilities", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClinicalSupervisors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClinicalSupervisors_ClinicalFacilities_FacilityId",
                        column: x => x.FacilityId,
                        principalTable: "ClinicalFacilities",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClinicalPlacements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClinicalPlacements_ClinicalFacilities_FacilityId",
                        column: x => x.FacilityId,
                        principalTable: "ClinicalFacilities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClinicalPlacements_ClinicalSupervisors_SupervisorId",
                        column: x => x.SupervisorId,
                        principalTable: "ClinicalSupervisors",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ClinicalPlacements_Students_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClassSessions_CourseOfferings_CourseOfferingId",
                        column: x => x.CourseOfferingId,
                        principalTable: "CourseOfferings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfessionalismScore = table.Column<int>(type: "integer", nullable: false),
                    SkillScore = table.Column<int>(type: "integer", nullable: false),
                    CommunicationScore = table.Column<int>(type: "integer", nullable: false),
                    AttendanceScore = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClinicalEvaluations_ClinicalPlacements_PlacementId",
                        column: x => x.PlacementId,
                        principalTable: "ClinicalPlacements",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClinicalEvaluations_Users_EvaluatorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Marks_AssessmentComponents_AssessmentComponentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassSessions_CourseOfferingId",
                table: "ClassSessions",
                column: "CourseOfferingId");

            migrationBuilder.CreateIndex(
                name: "IX_ClinicalEvaluations_EvaluatorId",
                table: "ClinicalEvaluations",
                column: "EvaluatorId");

            migrationBuilder.CreateIndex(
                name: "IX_ClinicalEvaluations_PlacementId",
                table: "ClinicalEvaluations",
                column: "PlacementId");

            migrationBuilder.CreateIndex(
                name: "IX_ClinicalPlacements_FacilityId",
                table: "ClinicalPlacements",
                column: "FacilityId");

            migrationBuilder.CreateIndex(
                name: "IX_ClinicalPlacements_StudentId",
                table: "ClinicalPlacements",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_ClinicalPlacements_SupervisorId",
                table: "ClinicalPlacements",
                column: "SupervisorId");

            migrationBuilder.CreateIndex(
                name: "IX_ClinicalSupervisors_FacilityId",
                table: "ClinicalSupervisors",
                column: "FacilityId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Marks_AssessmentComponentId",
                table: "Marks",
                column: "AssessmentComponentId");

            migrationBuilder.CreateIndex(
                name: "IX_Marks_EnteredBy",
                table: "Marks",
                column: "EnteredBy");
